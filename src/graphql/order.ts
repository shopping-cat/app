...
// QUERY/ORDER_DATA_TO_PG_DATA
export const ORDER_DATA_TO_PG_DATA = gql`
query ($cartItemIds:[Int]!, $coupons:[OrderCouponArg!]!, $point: Int!, $amount:Int!){
    orderDataToPGData(cartItemIds:$cartItemIds, coupons:$coupons, point:$point, amount:$amount) {
        amount
        name
        uid
        user {
...
interface OrderDataToPGDataData {
    orderDataToPGData: {
        amount: number
        name: string
        uid: string
...
interface OrderDataToPGDataVars {
    cartItemIds: number[]
    coupons: OrderCalculateCouponVar[]
    point: number
    amount: number
}
export const useOrderDataToPGData = (options?: QueryHookOptions<OrderDataToPGDataData, OrderDataToPGDataVars>) => createQueryHook<OrderDataToPGDataData, OrderDataToPGDataVars>(ORDER_DATA_TO_PG_DATA, {
    ...options,
})
